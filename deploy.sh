...
echo ""
echo "🎨 Want a web interface? Deploy the optional frontend:"
echo "  git clone https://github.com/tacssuki/EphemeralMail-svelte.git"
echo "  cd EphemeralMail-svelte"
echo "  sudo ./deploy.sh $DOMAIN"
echo ""
echo "📚 Documentation:"
echo "  • Backend API Guide: https://github.com/tacssuki/EphemeralMail"
echo "  • Optional Frontend: https://github.com/tacssuki/EphemeralMail-svelte"
...
echo ""
echo "✨ Your temporary email API service is now live!"
echo "🌐 API available at: https://$DOMAIN/api/"
echo "📚 Interactive docs: https://$DOMAIN/api-docs"
